...
import com.joshuacrotts.view.mainscreen.TableSelectionPanel;
 ...
 * @author Joshua
 */
public class TableSelect extends JComboBox implements ItemListener {

    private final InformationPanel globalPanel;
    private final TableSelectionPanel parentPanel;

    public static String[] sortColumns;

    public TableSelect (InformationPanel globalPanel, TableSelectionPanel parentPanel) {
    ...
    public void updateTableColumns (String[] columns) {
    ...
    private void setDefaultSelection () {
        this.setRenderer(new MyComboBoxRenderer("SELECT TABLE"));
